...
count_of_loans = len(loan_costs)
print(f"Number of loans = {count_of_loans}")
...
print(f"Total value of the loans ${round(sum_of_loans)}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount

average_loan_amount = sum_of_loans / count_of_loans
print(f"Average loan amount ${round(average_loan_amount)}")
...
print(f"Fair Value if the loan = ${round(fair_value)}")
